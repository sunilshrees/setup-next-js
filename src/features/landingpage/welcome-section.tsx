...
const WelcomeSection = () => {
  ...
  return (
    <div ref={containerRef} className="w-full ">
      <div className="w-full flex items-center justify-start px-4 md:px-16 overflow-hidden pt-16 relative">
        <motion.div
          initial={{ width: "100%" }}
          animate={imageControls}
          className="overflow-hidden rounded-lg shadow-lg relative h-[500px] shrink-0"
        >
          <Image
