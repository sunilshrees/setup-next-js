    ...
    <div className="min-h-screen">
      <div className="max-w-screen-xl mx-auto pt-14 relative space-y-20">
        <div className="w-full flex flex-col justify-center items-center space-y-8 mb-12 relative">
          ...
          <h1 className="text-5xl font-medium text-primary">Accommodation</h1>
          <p className="text-center text-base max-w-4xl text-[#393939]">
            SDA and SIL accommodation with Matilda Disability Services
          </p>
          <Link href="/services">
            <Button
        ...
        <div className="rounded-[3rem] bg-[#F5F7F8] grid grid-cols-2 gap-12 p-[2rem]">
          <div className="space-y-2 ">
            <h2 className="font-bold text-[#707070] text-base">
              Disability Services
            </h2>
            <h1 className="font-medium text-2xl text-primary">
              Find your perfect NDIS-approved disability accommodation with
              Matilda Care.
            </h1>
            <p className="text-[#707070] font-medium">
              Matilda Care Services provides NDIS-approved disability
              accommodations in Perth, designed to empower individuals with
              personalized, compassionate support. Our homes prioritize
              independence, safety, and comfort, tailored to your unique needs
              and goals. With a focus on fostering confidence, community
              connection, and well-being, we create welcoming environments where
              you or your loved one can thrive. Choose Matilda Care for
              exceptional care that respects your dignity and supports your
              aspirations, ensuring a fulfilling life with the right resources
              at every step.
            </p>
          </div>
          <div className="w-full aspect-video overflow-hidden relative">
