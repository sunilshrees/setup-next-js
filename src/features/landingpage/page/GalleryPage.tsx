    ...
    <div className="min-h-screen">
      <div className="max-w-screen-xl mx-auto pt-14 relative space-y-20">
        <div className="w-full flex flex-col justify-center items-center space-y-8 mb-12 relative">
          ...
          <h1 className="text-5xl font-medium text-primary">Our Gallery</h1>
        ...
        <div className="min-h-screen">
          <div className="rounded-[2rem] overflow-hidden grid grid-cols-2 gap-8">
            {new Array(3).fill(0).map((_, index) => (
              <Card className="rounded-[2rem] cursor-pointers">
                <div className="relative w-full aspect-video overflow-hidden rounded-t-[2rem] ">
                  <Image
                    ...
                    alt="Lisa"
                    fill
                    className="rounded-t-[2rem] object-cover group-hover:scale-150 transition-all duration-500 ease-in-out"
                  />
                </div>
                <div className="flex flex-col gap-4 p-4">
                  <h1>Matilda Gallery - Empowered Expressions</h1>
                  <div className="flex justify-end items-center">
                    <Button
                      variant={"outline"}
                      className="bg-transparent rounded-xl h-auto px-5 py-3 flex gap-4 items-center"
                    >
                      <Eye />
                      View Gallery
                    </Button>
