      ...
      <div className="max-w-screen-xl mx-auto pt-14 relative space-y-20">
        <div className="w-full flex flex-col justify-center items-center space-y-8 mb-12 relative">
          ...
          <p className="text-center text-base max-w-4xl text-[#393939]">
            ...
            comfortable, and empowering home environment.
          </p>
          <Link href="/services">
            <Button
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          {new Array(5).fill(0).map((_, index) => (
            <div
              key={index}
              className="max-w-lg mx-auto bg-white rounded-[3rem] flex relative border-r-4 border-b-4 border-transparent hover:border-primary transition-all duration-300 cursor-pointer"
            >
              <div className="bg-[#DEF4C6] w-1/4 rounded-l-[3rem] flex items-center justify-center relative">
                ...
                <div className="absolute top-1/2 -translate-y-1/2 -right-[30%]">
              ...
              <div className="w-3/4 px-14 py-12 flex flex-col justify-between">
                <div className="relative">
                  ...
                  <p className="text-gray-700 text-sm">
                    &quot; Working with Matilda Care has been life-changing for
                    our family. Their dedicated team provided personalized
                    support that truly understood our needs, &quot;
                  </p>
