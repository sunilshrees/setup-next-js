...
function Calendar({
  ...
  maxDate,
  ...props
}: CalendarProps & { yearRange?: number; maxDate?: any }) {
            ...
            <div className="inline-flex gap-2">
              <Select
                ...
                onValueChange={(value) => {
                  ...
                  if (
                    !isMonthDisabled(newDate.getMonth(), newDate.getFullYear())
                  ) {
                ...
                <SelectContent className="z-[200]">
                  {YEARS.map((year) => (
                    <SelectItem
                      ...
                      disabled={maxDate && year.value > maxDate.getFullYear()}
                    >
                      {year.label}
                    </SelectItem>
                  ))}
        ...
        >
          ...
          >
            <Button
              variant="outline"
              className={cn(
                "w-full justify-between text-left font-normal relative shadow-none hover:bg-transparent",
                !displayDate && "",
            ...
            >
              ...
              {displayDate ? (
                format(displayDate, "MM-dd-yyyy", { locale: loc })
              ) : (
            ...
            {error && (
              <p className="mt-1 text-xs text-destructive flex items-center gap-1">
                ...
                />
                <span className="mt-0">{error}</span>
              </p>
            )}
          </div>
        </PopoverTrigger>
